...
const Speakers: React.FC = () => {
  return (
    <div className="relative">
      <SpeakerTop className="h-auto w-full translate-y-3 transform" />
      <div className="flex h-[800px] flex-col gap-4 bg-gradient-to-t from-[#6DB0CE] to-[#50769F] px-8 py-24 md:p-32">
        ...
        <p className="text-sm font-medium text-white md:text-2xl">
          DeltaHacks is your chance to learn directly from leading figures in
          tech.
          <br className="hidden md:block" />
          Here are just a few of the past keynote speakers we&apos;ve invited to
          speak:
        </p>
      ...
      <SpeakerDown className="h-auto w-full -translate-y-8 transform" />
    </div>
  );
};
