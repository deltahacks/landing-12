...
const Hero: React.FC = async () => {
  ...
  return (
    <main className="grid h-[80vh] grid-cols-1 grid-rows-1 bg-gradient-to-b from-[#182B8C] to-[#B2ACEA] md:h-screen">
      ...
      <div className="col-start-1 col-end-1 row-start-1 row-end-1 px-4 pt-32 md:pt-24 lg:pt-32 text-center text-white md:px-12 lg:px-24 md:text-left">
        ...
        <p className="font-fredoka text-xs md:text-lg lg:text-2xl py-3">
