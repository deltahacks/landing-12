      ...
      <div className="flex items-center justify-center px-6 md:px-16">
        <div className="relative">
          ...
          <div className="absolute inset-0 mt-16 flex items-center justify-center md:mt-20">
            <div className="w-87 h-215 md:w-250 md:h-130 md:transform md:-translate-y-13 overflow-hidden rounded-2xl border border-white/30 bg-white/10 shadow-2xl backdrop-blur-md">
              <div className="p-1 lg:p-3">
                <div className="flex flex-col md:gap-0 md:flex-row lg:gap-4">
