...
const About: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  return (
    ...
    >
      <div
        className={`md:border-dh-border flex h-full w-full flex-col items-center justify-center overflow-hidden md:max-w-4xl md:rounded-lg md:border-4 relative`}
      >
        <span className="h-1 w-full bg-dh-border md:mt-4"></span>
        <span className="absolute h-1 w-full md:bg-dh-border top-[270px] left-0 -z-10"></span>
        <h1 className="font-funky text-dh-blue py-3 text-5xl md:text-8xl">DINO-MART</h1>
        <div className="text-dh-blue flex flex-row gap-24 md:gap-32 text-2xl md:text-4xl font-semibold">
          <h2>About</h2>
          <h2>DH12!</h2>
        </div>
        ...
        <div className="p-4 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 text-dh-gold">
