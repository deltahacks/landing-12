...
const About: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col items-center border-t-4 md:border-y-4 border-dh-border w-full mt-4">
          <div className="transform translate-y-8">
            <div className="flex flex-col items-center transform translate-y-16 -mt-24">
              <h1 className="font-funky text-dh-blue py-3 text-5xl md:text-8xl ">
                DINO-MART
              </h1>
              <div className="text-dh-blue flex flex-row gap-24 text-2xl font-semibold md:gap-32 md:text-4xl justify-center items-center">
                <h2>About</h2>
                <h2>DH12!</h2>
              </div>
            </div>
